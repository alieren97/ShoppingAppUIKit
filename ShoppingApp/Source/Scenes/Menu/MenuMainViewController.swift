...
//  ShoppingApp
//
//  Created by AliEren on 13.07.2022.
//
...
class MenuMainViewController: UIViewController {
    ...
    let menuController = MenuController(pageName: "menu",collectionViewLayout: UICollectionViewFlowLayout())
//    let menuController = MenuController(pageName: "menu")
    ...
    private func setupPageController() {
        ...
        viewControllers = [
            CategoriesViewController(gender:Genders.Man.rawValue),
            CategoriesViewController(gender:Genders.Woman.rawValue),
            CategoriesViewController(gender:Genders.Child.rawValue)
        ]
...
extension MenuMainViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
...
extension MenuMainViewController: MenuControllerDelegate {
